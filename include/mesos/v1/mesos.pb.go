...
type CheckInfo struct {
	...
	DelaySeconds *float64 `protobuf:"fixed64,4,opt,name=delay_seconds,def=15" json:"delay_seconds,omitempty"`
	...
	IntervalSeconds *float64 `protobuf:"fixed64,5,opt,name=interval_seconds,def=10" json:"interval_seconds,omitempty"`
	...
	TimeoutSeconds   *float64 `protobuf:"fixed64,6,opt,name=timeout_seconds,def=20" json:"timeout_seconds,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
type DomainInfo struct {
	FaultDomain      *DomainInfo_FaultDomain `protobuf:"bytes,1,opt,name=fault_domain" json:"fault_domain,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
...
type ResourceProviderInfo struct {
	...
	DefaultReservations []*Resource_ReservationInfo   `protobuf:"bytes,5,rep,name=default_reservations" json:"default_reservations,omitempty"`
...
type Resource struct {
	ProviderId *ResourceProviderID `protobuf:"bytes,12,opt,name=provider_id" json:"provider_id,omitempty"`
	Name       *string             `protobuf:"bytes,1,req,name=name" json:"name,omitempty"`
	Type       *Value_Type         `protobuf:"varint,2,req,name=type,enum=mesos.v1.Value_Type" json:"type,omitempty"`
	Scalar     *Value_Scalar       `protobuf:"bytes,3,opt,name=scalar" json:"scalar,omitempty"`
	Ranges     *Value_Ranges       `protobuf:"bytes,4,opt,name=ranges" json:"ranges,omitempty"`
	...
	Role           *string                  `protobuf:"bytes,6,opt,name=role,def=*" json:"role,omitempty"`
	AllocationInfo *Resource_AllocationInfo `protobuf:"bytes,11,opt,name=allocation_info" json:"allocation_info,omitempty"`
...
type IpStatistics struct {
	Forwarding       *int64 `protobuf:"varint,1,opt" json:"Forwarding,omitempty"`
	DefaultTTL       *int64 `protobuf:"varint,2,opt" json:"DefaultTTL,omitempty"`
	InReceives       *int64 `protobuf:"varint,3,opt" json:"InReceives,omitempty"`
	InHdrErrors      *int64 `protobuf:"varint,4,opt" json:"InHdrErrors,omitempty"`
	InAddrErrors     *int64 `protobuf:"varint,5,opt" json:"InAddrErrors,omitempty"`
	ForwDatagrams    *int64 `protobuf:"varint,6,opt" json:"ForwDatagrams,omitempty"`
	InUnknownProtos  *int64 `protobuf:"varint,7,opt" json:"InUnknownProtos,omitempty"`
	InDiscards       *int64 `protobuf:"varint,8,opt" json:"InDiscards,omitempty"`
	InDelivers       *int64 `protobuf:"varint,9,opt" json:"InDelivers,omitempty"`
	OutRequests      *int64 `protobuf:"varint,10,opt" json:"OutRequests,omitempty"`
	OutDiscards      *int64 `protobuf:"varint,11,opt" json:"OutDiscards,omitempty"`
	OutNoRoutes      *int64 `protobuf:"varint,12,opt" json:"OutNoRoutes,omitempty"`
	ReasmTimeout     *int64 `protobuf:"varint,13,opt" json:"ReasmTimeout,omitempty"`
	ReasmReqds       *int64 `protobuf:"varint,14,opt" json:"ReasmReqds,omitempty"`
	ReasmOKs         *int64 `protobuf:"varint,15,opt" json:"ReasmOKs,omitempty"`
	ReasmFails       *int64 `protobuf:"varint,16,opt" json:"ReasmFails,omitempty"`
	FragOKs          *int64 `protobuf:"varint,17,opt" json:"FragOKs,omitempty"`
	FragFails        *int64 `protobuf:"varint,18,opt" json:"FragFails,omitempty"`
	FragCreates      *int64 `protobuf:"varint,19,opt" json:"FragCreates,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type IcmpStatistics struct {
	InMsgs           *int64 `protobuf:"varint,1,opt" json:"InMsgs,omitempty"`
	InErrors         *int64 `protobuf:"varint,2,opt" json:"InErrors,omitempty"`
	InCsumErrors     *int64 `protobuf:"varint,3,opt" json:"InCsumErrors,omitempty"`
	InDestUnreachs   *int64 `protobuf:"varint,4,opt" json:"InDestUnreachs,omitempty"`
	InTimeExcds      *int64 `protobuf:"varint,5,opt" json:"InTimeExcds,omitempty"`
	InParmProbs      *int64 `protobuf:"varint,6,opt" json:"InParmProbs,omitempty"`
	InSrcQuenchs     *int64 `protobuf:"varint,7,opt" json:"InSrcQuenchs,omitempty"`
	InRedirects      *int64 `protobuf:"varint,8,opt" json:"InRedirects,omitempty"`
	InEchos          *int64 `protobuf:"varint,9,opt" json:"InEchos,omitempty"`
	InEchoReps       *int64 `protobuf:"varint,10,opt" json:"InEchoReps,omitempty"`
	InTimestamps     *int64 `protobuf:"varint,11,opt" json:"InTimestamps,omitempty"`
	InTimestampReps  *int64 `protobuf:"varint,12,opt" json:"InTimestampReps,omitempty"`
	InAddrMasks      *int64 `protobuf:"varint,13,opt" json:"InAddrMasks,omitempty"`
	InAddrMaskReps   *int64 `protobuf:"varint,14,opt" json:"InAddrMaskReps,omitempty"`
	OutMsgs          *int64 `protobuf:"varint,15,opt" json:"OutMsgs,omitempty"`
	OutErrors        *int64 `protobuf:"varint,16,opt" json:"OutErrors,omitempty"`
	OutDestUnreachs  *int64 `protobuf:"varint,17,opt" json:"OutDestUnreachs,omitempty"`
	OutTimeExcds     *int64 `protobuf:"varint,18,opt" json:"OutTimeExcds,omitempty"`
	OutParmProbs     *int64 `protobuf:"varint,19,opt" json:"OutParmProbs,omitempty"`
	OutSrcQuenchs    *int64 `protobuf:"varint,20,opt" json:"OutSrcQuenchs,omitempty"`
	OutRedirects     *int64 `protobuf:"varint,21,opt" json:"OutRedirects,omitempty"`
	OutEchos         *int64 `protobuf:"varint,22,opt" json:"OutEchos,omitempty"`
	OutEchoReps      *int64 `protobuf:"varint,23,opt" json:"OutEchoReps,omitempty"`
	OutTimestamps    *int64 `protobuf:"varint,24,opt" json:"OutTimestamps,omitempty"`
	OutTimestampReps *int64 `protobuf:"varint,25,opt" json:"OutTimestampReps,omitempty"`
	OutAddrMasks     *int64 `protobuf:"varint,26,opt" json:"OutAddrMasks,omitempty"`
	OutAddrMaskReps  *int64 `protobuf:"varint,27,opt" json:"OutAddrMaskReps,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type TcpStatistics struct {
	RtoAlgorithm     *int64 `protobuf:"varint,1,opt" json:"RtoAlgorithm,omitempty"`
	RtoMin           *int64 `protobuf:"varint,2,opt" json:"RtoMin,omitempty"`
	RtoMax           *int64 `protobuf:"varint,3,opt" json:"RtoMax,omitempty"`
	MaxConn          *int64 `protobuf:"varint,4,opt" json:"MaxConn,omitempty"`
	ActiveOpens      *int64 `protobuf:"varint,5,opt" json:"ActiveOpens,omitempty"`
	PassiveOpens     *int64 `protobuf:"varint,6,opt" json:"PassiveOpens,omitempty"`
	AttemptFails     *int64 `protobuf:"varint,7,opt" json:"AttemptFails,omitempty"`
	EstabResets      *int64 `protobuf:"varint,8,opt" json:"EstabResets,omitempty"`
	CurrEstab        *int64 `protobuf:"varint,9,opt" json:"CurrEstab,omitempty"`
	InSegs           *int64 `protobuf:"varint,10,opt" json:"InSegs,omitempty"`
	OutSegs          *int64 `protobuf:"varint,11,opt" json:"OutSegs,omitempty"`
	RetransSegs      *int64 `protobuf:"varint,12,opt" json:"RetransSegs,omitempty"`
	InErrs           *int64 `protobuf:"varint,13,opt" json:"InErrs,omitempty"`
	OutRsts          *int64 `protobuf:"varint,14,opt" json:"OutRsts,omitempty"`
	InCsumErrors     *int64 `protobuf:"varint,15,opt" json:"InCsumErrors,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type UdpStatistics struct {
	InDatagrams      *int64 `protobuf:"varint,1,opt" json:"InDatagrams,omitempty"`
	NoPorts          *int64 `protobuf:"varint,2,opt" json:"NoPorts,omitempty"`
	InErrors         *int64 `protobuf:"varint,3,opt" json:"InErrors,omitempty"`
	OutDatagrams     *int64 `protobuf:"varint,4,opt" json:"OutDatagrams,omitempty"`
	RcvbufErrors     *int64 `protobuf:"varint,5,opt" json:"RcvbufErrors,omitempty"`
	SndbufErrors     *int64 `protobuf:"varint,6,opt" json:"SndbufErrors,omitempty"`
	InCsumErrors     *int64 `protobuf:"varint,7,opt" json:"InCsumErrors,omitempty"`
	IgnoredMulti     *int64 `protobuf:"varint,8,opt" json:"IgnoredMulti,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type DiskStatistics struct {
	...
	LimitBytes       *uint64                        `protobuf:"varint,3,opt,name=limit_bytes" json:"limit_bytes,omitempty"`
	UsedBytes        *uint64                        `protobuf:"varint,4,opt,name=used_bytes" json:"used_bytes,omitempty"`
	XXX_unrecognized []byte                         `json:"-"`
}
...
type ResourceStatistics struct {
	...
	DiskStatistics []*DiskStatistics `protobuf:"bytes,43,rep,name=disk_statistics" json:"disk_statistics,omitempty"`
	// Cgroups blkio statistics.
	BlkioStatistics *CgroupInfo_Blkio_Statistics `protobuf:"bytes,44,opt,name=blkio_statistics" json:"blkio_statistics,omitempty"`
	// Perf statistics.
...
type Offer struct {
	...
	AllocationInfo   *Resource_AllocationInfo `protobuf:"bytes,10,opt,name=allocation_info" json:"allocation_info,omitempty"`
	XXX_unrecognized []byte                   `json:"-"`
}
...
type Offer_Operation struct {
	...
	CreateVolume     *Offer_Operation_CreateVolume  `protobuf:"bytes,8,opt,name=create_volume" json:"create_volume,omitempty"`
	DestroyVolume    *Offer_Operation_DestroyVolume `protobuf:"bytes,9,opt,name=destroy_volume" json:"destroy_volume,omitempty"`
	CreateBlock      *Offer_Operation_CreateBlock   `protobuf:"bytes,10,opt,name=create_block" json:"create_block,omitempty"`
	DestroyBlock     *Offer_Operation_DestroyBlock  `protobuf:"bytes,11,opt,name=destroy_block" json:"destroy_block,omitempty"`
	XXX_unrecognized []byte                         `json:"-"`
}
...
type Offer_Operation_CreateVolume struct {
	...
	TargetType       *Resource_DiskInfo_Source_Type `protobuf:"varint,2,req,name=target_type,enum=mesos.v1.Resource_DiskInfo_Source_Type" json:"target_type,omitempty"`
	XXX_unrecognized []byte                         `json:"-"`
}
...
type Operation struct {
	...
	LatestStatus *OperationStatus `protobuf:"bytes,4,req,name=latest_status" json:"latest_status,omitempty"`
...
type OperationStatus struct {
	...
	// set.
	OperationId *OperationID    `protobuf:"bytes,1,opt,name=operation_id" json:"operation_id,omitempty"`
	...
	ConvertedResources []*Resource `protobuf:"bytes,4,rep,name=converted_resources" json:"converted_resources,omitempty"`
...
type CheckStatusInfo_Command struct {
	...
	ExitCode         *int32 `protobuf:"varint,1,opt,name=exit_code" json:"exit_code,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type TaskStatus struct {
	...
	//
	// NOTE: Check support in built-in executors is experimental.
	CheckStatus *CheckStatusInfo `protobuf:"bytes,15,opt,name=check_status" json:"check_status,omitempty"`
	// Labels are free-form key value pairs which are exposed through
	// master and agent endpoints. Labels will not be interpreted or
	// acted upon by Mesos itself. As opposed to the data field, labels
	// will be kept in memory on master and agent processes. Therefore,
...
type Volume_Source struct {
	...
	HostPath     *Volume_Source_HostPath     `protobuf:"bytes,5,opt,name=host_path" json:"host_path,omitempty"`
...
type Volume_Source_HostPath struct {
	...
	MountPropagation *MountPropagation `protobuf:"bytes,2,opt,name=mount_propagation" json:"mount_propagation,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}
...
type LinuxInfo struct {
	...
	// granted to tasks.
	BoundingCapabilities *CapabilityInfo `protobuf:"bytes,2,opt,name=bounding_capabilities" json:"bounding_capabilities,omitempty"`
	// Represents the set of capabilities that the task will
	// be executed with.
	EffectiveCapabilities *CapabilityInfo `protobuf:"bytes,3,opt,name=effective_capabilities" json:"effective_capabilities,omitempty"`
	...
	SharePidNamespace *bool  `protobuf:"varint,4,opt,name=share_pid_namespace" json:"share_pid_namespace,omitempty"`
	XXX_unrecognized  []byte `json:"-"`
}
...
type CgroupInfo_Blkio_CFQ_Statistics struct {
	...
	// blkio.io_serviced
	IoServiced []*CgroupInfo_Blkio_Value `protobuf:"bytes,4,rep,name=io_serviced" json:"io_serviced,omitempty"`
	// blkio.io_service_bytes
	IoServiceBytes []*CgroupInfo_Blkio_Value `protobuf:"bytes,5,rep,name=io_service_bytes" json:"io_service_bytes,omitempty"`
	// blkio.io_service_time
	IoServiceTime []*CgroupInfo_Blkio_Value `protobuf:"bytes,6,rep,name=io_service_time" json:"io_service_time,omitempty"`
	// blkio.io_wait_time
	IoWaitTime []*CgroupInfo_Blkio_Value `protobuf:"bytes,7,rep,name=io_wait_time" json:"io_wait_time,omitempty"`
	// blkio.io_merged
	IoMerged []*CgroupInfo_Blkio_Value `protobuf:"bytes,8,rep,name=io_merged" json:"io_merged,omitempty"`
	// blkio.io_queued
	IoQueued         []*CgroupInfo_Blkio_Value `protobuf:"bytes,9,rep,name=io_queued" json:"io_queued,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type CgroupInfo_Blkio_Throttling_Statistics struct {
	...
	IoServiced []*CgroupInfo_Blkio_Value `protobuf:"bytes,2,rep,name=io_serviced" json:"io_serviced,omitempty"`
	// blkio.throttle.io_service_bytes
	IoServiceBytes   []*CgroupInfo_Blkio_Value `protobuf:"bytes,3,rep,name=io_service_bytes" json:"io_service_bytes,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
type CgroupInfo_Blkio_Statistics struct {
	...
	CfqRecursive     []*CgroupInfo_Blkio_CFQ_Statistics        `protobuf:"bytes,2,rep,name=cfq_recursive" json:"cfq_recursive,omitempty"`
...
type Device_Number struct {
	MajorNumber      *uint64 `protobuf:"varint,1,req,name=major_number" json:"major_number,omitempty"`
	MinorNumber      *uint64 `protobuf:"varint,2,req,name=minor_number" json:"minor_number,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type DeviceWhitelist struct {
	AllowedDevices   []*DeviceAccess `protobuf:"bytes,1,rep,name=allowed_devices" json:"allowed_devices,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
